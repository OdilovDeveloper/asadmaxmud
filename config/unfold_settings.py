        ...
        "navigation": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "title": _("Yutuqli Quti Link"),
                        "icon": "link",
                        "link": reverse_lazy("admin:case_create_caselink_changelist"),
                    },
                    {
                        "title": _("SMS yuborish"),
                        "icon": "settings",
                        "link": reverse_lazy("admin:sendSms_sendsmsmodel_changelist"),
                    },
                    {
                        "title": _("Telga SMS yuborish"),
                        "icon": "settings",
                        "link": reverse_lazy("admin:sendSms_freesmsmodel_changelist"),
                    },
                    {
                        "title": _("PaymentSession"),
                        "icon": "settings",
                        "link": reverse_lazy("admin:order_paymentsession_changelist"),
                    },
                    {
                        "title": _("Jonli efir link"),
                        "icon": "link",
                        "link": reverse_lazy("admin:live_livelink_changelist"),
                    },
                ],
            },
            {
